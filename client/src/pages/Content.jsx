          ...
          <Wrapper1>
            <Wrapper2>
              <TitleLevelBox>
                ...
                <LevelBox>
                  <h3>
                    <IoPodiumOutline /> 단어 난이도 :{' '}
                    {content.word_difficulty_level}
                  </h3>
                  <h3>
                    <SiSpeedtest /> WPS : {content.words_per_second}
                  </h3>
                  <h3>
                    <IoBookmarksSharp /> 종합 난이도 : {content.content_level} /
                    10
                  </h3>
                </LevelBox>
              </TitleLevelBox>
