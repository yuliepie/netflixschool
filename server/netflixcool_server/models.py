...
class ContentWordLevels(db.Model):
    ...
    level_7 = db.Column(db.Integer, nullable=False)
    level_8 = db.Column(db.Integer, nullable=False)
    level_9 = db.Column(db.Integer, nullable=False)
    level_10 = db.Column(db.Integer, nullable=False)
    level_11 = db.Column(db.Integer, nullable=False)
    level_12 = db.Column(db.Integer, nullable=False)
    level_13 = db.Column(db.Integer, nullable=False)
    level_14 = db.Column(db.Integer, nullable=False)
    level_15 = db.Column(db.Integer, nullable=False)
